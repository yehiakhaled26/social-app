...
router.patch("/send-forget-password", (0, validation_middleware_1.validation)(validators.sendForgetPasswordCode), auth_service_1.default.sendForgetCode);
router.patch("/verify-forget-password", (0, validation_middleware_1.validation)(validators.verifyForgetPassword), auth_service_1.default.verifyForgetCode);
router.patch("/reset-forget-password", (0, validation_middleware_1.validation)(validators.ResetForgetPassword), auth_service_1.default.resetForgetCode);
